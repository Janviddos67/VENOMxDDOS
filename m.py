...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @JANVI_GAMING 🙇."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @JANVI_GAMING")
